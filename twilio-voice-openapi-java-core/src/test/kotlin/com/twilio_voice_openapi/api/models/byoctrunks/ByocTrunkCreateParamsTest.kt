...
class ByocTrunkCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = ByocTrunkCreateParams.builder()
          .cnamLookupEnabled(false)
          .connectionPolicySid("NYaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
          .friendlyName("friendly_name")
          .fromDomainSid("SDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
      ...
      assertThat(body.statusCallbackMethod()).contains(ByocTrunkCreateParams.StatusCallbackMethod.GET)
      assertThat(body.statusCallbackUrl()).contains("https://byoc.example.com/twilio/status_callback")
      assertThat(body.voiceFallbackMethod()).contains(ByocTrunkCreateParams.VoiceFallbackMethod.GET)
