...
internal class ConnectionPolicyTargetTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedConnectionPolicyTarget =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(connectionPolicyTarget),
                jacksonTypeRef<ConnectionPolicyTarget>(),
            )

        assertThat(roundtrippedConnectionPolicyTarget).isEqualTo(connectionPolicyTarget)
    }
}
