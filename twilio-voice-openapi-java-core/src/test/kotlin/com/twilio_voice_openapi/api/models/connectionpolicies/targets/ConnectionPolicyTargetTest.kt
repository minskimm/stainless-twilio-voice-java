...
class ConnectionPolicyTargetTest {

    @Disabled("skipped: tests are disabled for the time being")
    @Test
    fun createConnectionPolicyTarget() {
      val connectionPolicyTarget = ConnectionPolicyTarget.builder()
      ...
      assertThat(connectionPolicyTarget.accountSid()).contains("ACE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
      assertThat(connectionPolicyTarget.connectionPolicySid()).contains("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
      assertThat(connectionPolicyTarget.dateCreated()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(connectionPolicyTarget.dateUpdated()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
