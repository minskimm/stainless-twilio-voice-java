...
class ByocTrunkUpdateParamsTest {
    ...
    @Test
    fun body() {
      val params = ByocTrunkUpdateParams.builder()
          .sid("BYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .cnamLookupEnabled(true)
          .connectionPolicySid("NYaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab")
          .friendlyName("update_name")
      ...
      assertThat(body.statusCallbackMethod()).contains(ByocTrunkUpdateParams.StatusCallbackMethod.GET)
      assertThat(body.statusCallbackUrl()).contains("https://byoc.example.com/twilio_updated/status_callback")
      assertThat(body.voiceFallbackMethod()).contains(ByocTrunkUpdateParams.VoiceFallbackMethod.GET)
      assertThat(body.voiceFallbackUrl()).contains("https://byoc.example.com/twilio_updated/fallback")
