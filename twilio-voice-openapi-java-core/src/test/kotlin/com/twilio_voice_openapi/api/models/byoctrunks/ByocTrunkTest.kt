...
class ByocTrunkTest {
    ...
    @Test
    fun createByocTrunk() {
      val byocTrunk = ByocTrunk.builder()
      ...
      assertThat(byocTrunk.dateCreated()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(byocTrunk.dateUpdated()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
