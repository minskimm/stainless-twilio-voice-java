...
class ConnectionPolicyTest {
    ...
    fun createConnectionPolicy() {
      val connectionPolicy = ConnectionPolicy.builder()
      ...
      assertThat(connectionPolicy.dateCreated()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(connectionPolicy.dateUpdated()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
