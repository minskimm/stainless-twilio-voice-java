...
class CountryListResponseTest {
    ...
    fun createCountryListResponse() {
      val countryListResponse = CountryListResponse.builder()
          .addContent(CountryListResponse.Content.builder()
              .continent("continent")
              ...
              .build())
          .meta(CountryListResponse.Meta.builder()
      ...
      assertThat(countryListResponse.content().get()).containsExactly(CountryListResponse.Content.builder()
          .continent("continent")
          .addCountryCode("string")
          .highRiskSpecialNumbersEnabled(true)
          .highRiskTollfraudNumbersEnabled(true)
          ...
          .url("https://example.com")
          .build())
      assertThat(countryListResponse.meta()).contains(CountryListResponse.Meta.builder()
          .firstPageUrl("https://example.com")
          .key("key")
          .nextPageUrl("https://example.com")
          .page(0L)
