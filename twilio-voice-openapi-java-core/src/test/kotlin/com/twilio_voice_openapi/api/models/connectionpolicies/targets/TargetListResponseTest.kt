...
class TargetListResponseTest {

    @Disabled("skipped: tests are disabled for the time being")
    @Test
    fun createTargetListResponse() {
      val targetListResponse = TargetListResponse.builder()
          .meta(TargetListResponse.Meta.builder()
              ...
              .build())
          .addTarget(ConnectionPolicyTarget.builder()
      ...
      assertThat(targetListResponse.meta()).contains(TargetListResponse.Meta.builder()
          .firstPageUrl("https://example.com")
          .key("key")
          .nextPageUrl("https://example.com")
          .page(0L)
          ...
          .url("https://example.com")
          .build())
      assertThat(targetListResponse.targets().get()).containsExactly(ConnectionPolicyTarget.builder()
          .accountSid("ACE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .connectionPolicySid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .dateCreated(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .dateUpdated(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
