...
class ByocTrunkListResponseTest {

    @Disabled("skipped: tests are disabled for the time being")
    @Test
    fun createByocTrunkListResponse() {
      val byocTrunkListResponse = ByocTrunkListResponse.builder()
          .addByocTrunk(ByocTrunk.builder()
              ...
              .build())
          .meta(ByocTrunkListResponse.Meta.builder()
      ...
      assertThat(byocTrunkListResponse.byocTrunks().get()).containsExactly(ByocTrunk.builder()
          .accountSid("ACE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .cnamLookupEnabled(true)
          .connectionPolicySid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .dateCreated(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .voiceUrl("https://example.com")
          .build())
      assertThat(byocTrunkListResponse.meta()).contains(ByocTrunkListResponse.Meta.builder()
          .firstPageUrl("https://example.com")
          .key("key")
          .nextPageUrl("https://example.com")
          .page(0L)
