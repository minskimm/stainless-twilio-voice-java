...
class ConnectionPolicyServiceTest {
    ...
    fun create() {
      ...
      val connectionPolicy = connectionPolicyService.create(ConnectionPolicyCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val connectionPolicy = connectionPolicyService.retrieve(ConnectionPolicyRetrieveParams.builder()
    ...
    fun update() {
      ...
      val connectionPolicy = connectionPolicyService.update(ConnectionPolicyUpdateParams.builder()
          .sid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
    ...
    fun list() {
      ...
      val connectionPolicy = connectionPolicyService.list(ConnectionPolicyListParams.builder()
          .page(0L)
          .pageSize(1L)
          .pageToken("PageToken")
          .build())
    ...
    fun delete() {
      ...
      connectionPolicyService.delete(ConnectionPolicyDeleteParams.builder()
          .sid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .build())
    }
}
