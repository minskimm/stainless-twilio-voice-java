...
class IpRecordServiceAsyncTest {
    ...
    fun create() {
      ...
      val ipRecordFuture = ipRecordServiceAsync.create(IpRecordCreateParams.builder()
          .ipAddress("10.2.3.4")
    ...
    fun retrieve() {
      ...
      val ipRecordFuture = ipRecordServiceAsync.retrieve(IpRecordRetrieveParams.builder()
    ...
    fun update() {
      ...
      val ipRecordFuture = ipRecordServiceAsync.update(IpRecordUpdateParams.builder()
          .sid("ILE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
    ...
    fun list() {
      ...
      val ipRecordFuture = ipRecordServiceAsync.list(IpRecordListParams.builder()
          .page(0L)
          .pageSize(1L)
          .pageToken("PageToken")
          .build())
    ...
    fun delete() {
      ...
      val future = ipRecordServiceAsync.delete(IpRecordDeleteParams.builder()
          .sid("ILE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .build())
