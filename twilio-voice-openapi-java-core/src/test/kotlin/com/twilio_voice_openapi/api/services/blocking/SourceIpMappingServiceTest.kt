...
class SourceIpMappingServiceTest {
    ...
    fun create() {
      ...
      val sourceIpMapping = sourceIpMappingService.create(SourceIpMappingCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val sourceIpMapping = sourceIpMappingService.retrieve(SourceIpMappingRetrieveParams.builder()
    ...
    fun update() {
      ...
      val sourceIpMapping = sourceIpMappingService.update(SourceIpMappingUpdateParams.builder()
          .sid("IBE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
    ...
    fun list() {
      ...
      val sourceIpMapping = sourceIpMappingService.list(SourceIpMappingListParams.builder()
          .page(0L)
          .pageSize(1L)
          .pageToken("PageToken")
          .build())
    ...
    fun delete() {
      ...
      sourceIpMappingService.delete(SourceIpMappingDeleteParams.builder()
          .sid("IBE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .build())
    }
}
