...
class SourceIpMappingServiceAsyncTest {
    ...
    fun create() {
      ...
      val sourceIpMappingFuture = sourceIpMappingServiceAsync.create(SourceIpMappingCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val sourceIpMappingFuture = sourceIpMappingServiceAsync.retrieve(SourceIpMappingRetrieveParams.builder()
    ...
    fun update() {
      ...
      val sourceIpMappingFuture = sourceIpMappingServiceAsync.update(SourceIpMappingUpdateParams.builder()
          .sid("IBE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
    ...
    fun list() {
      ...
      val sourceIpMappingFuture = sourceIpMappingServiceAsync.list(SourceIpMappingListParams.builder()
          .page(0L)
          .pageSize(1L)
          .pageToken("PageToken")
          .build())
    ...
    fun delete() {
      ...
      val future = sourceIpMappingServiceAsync.delete(SourceIpMappingDeleteParams.builder()
          .sid("IBE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .build())
