...
class TargetServiceTest {
    ...
    fun create() {
      ...
      val connectionPolicyTarget = targetService.create(TargetCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val connectionPolicyTarget = targetService.retrieve(TargetRetrieveParams.builder()
          .connectionPolicySid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
    ...
    fun update() {
      ...
      val connectionPolicyTarget = targetService.update(TargetUpdateParams.builder()
          .connectionPolicySid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .sid("NEE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .enabled(false)
    ...
    fun list() {
      ...
      val target = targetService.list(TargetListParams.builder()
          .connectionPolicySid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .page(0L)
          .pageSize(1L)
          .pageToken("PageToken")
    ...
    fun delete() {
      ...
      targetService.delete(TargetDeleteParams.builder()
          .connectionPolicySid("NYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .sid("NEE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .build())
    }
