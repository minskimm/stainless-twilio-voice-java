...
class ByocTrunkServiceTest {
    ...
    fun create() {
      ...
      val byocTrunk = byocTrunkService.create(ByocTrunkCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val byocTrunk = byocTrunkService.retrieve(ByocTrunkRetrieveParams.builder()
    ...
    fun update() {
      ...
      val byocTrunk = byocTrunkService.update(ByocTrunkUpdateParams.builder()
          .sid("BYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
    ...
    fun list() {
      ...
      val byocTrunk = byocTrunkService.list(ByocTrunkListParams.builder()
          .page(0L)
          .pageSize(1L)
          .pageToken("PageToken")
          .build())
    ...
    fun delete() {
      ...
      byocTrunkService.delete(ByocTrunkDeleteParams.builder()
          .sid("BYE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD")
          .build())
    }
}
