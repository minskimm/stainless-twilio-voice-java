...
private constructor(
    ...
    private val sourceIpMappings: JsonField<List<SourceIpMapping>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        sourceIpMappings: JsonField<List<SourceIpMapping>> = JsonMissing.of(),
    ) : this(meta, sourceIpMappings, mutableMapOf())
    ...
    fun sourceIpMappings(): Optional<List<SourceIpMapping>> =
        sourceIpMappings.getOptional("source_ip_mappings")
    ...
    internal fun validity(): Int =
        (meta.asKnown().getOrNull()?.validity() ?: 0) +
            (sourceIpMappings.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
