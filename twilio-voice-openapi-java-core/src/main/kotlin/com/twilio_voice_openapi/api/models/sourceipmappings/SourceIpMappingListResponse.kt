...
@NoAutoDetect
class SourceIpMappingListResponse @JsonCreator private constructor(
    @JsonProperty("meta") @ExcludeMissing private val meta: JsonField<Meta> = JsonMissing.of(),
    @JsonProperty("source_ip_mappings") @ExcludeMissing private val sourceIpMappings: JsonField<List<SourceIpMapping>> = JsonMissing.of(),
    ...
    fun sourceIpMappings(): Optional<List<SourceIpMapping>> = Optional.ofNullable(sourceIpMappings.getNullable("source_ip_mappings"))
    ...
    fun validate(): SourceIpMappingListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceIpMappingListResponse: SourceIpMappingListResponse) =
            apply {
                meta = sourceIpMappingListResponse.meta
                sourceIpMappings = sourceIpMappingListResponse.sourceIpMappings.map { it.toMutableList() }
        ...
        fun sourceIpMappings(sourceIpMappings: List<SourceIpMapping>) = sourceIpMappings(JsonField.of(sourceIpMappings))

        fun sourceIpMappings(sourceIpMappings: JsonField<List<SourceIpMapping>>) =
            apply {
                this.sourceIpMappings = sourceIpMappings.map { it.toMutableList() }
            }

        fun addSourceIpMapping(sourceIpMapping: SourceIpMapping) =
            apply {
                sourceIpMappings = (sourceIpMappings ?: JsonField.of(mutableListOf())).also {
    ...
    override fun toString() = "SourceIpMappingListResponse{meta=$meta, sourceIpMappings=$sourceIpMappings, additionalProperties=$additionalProperties}"
}
