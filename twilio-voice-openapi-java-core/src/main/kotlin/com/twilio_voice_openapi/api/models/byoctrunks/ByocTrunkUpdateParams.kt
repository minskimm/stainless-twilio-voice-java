...
class ByocTrunkUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(byocTrunkUpdateParams: ByocTrunkUpdateParams) =
            apply {
    ...
    override fun toString() = "ByocTrunkUpdateParams{sid=$sid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
