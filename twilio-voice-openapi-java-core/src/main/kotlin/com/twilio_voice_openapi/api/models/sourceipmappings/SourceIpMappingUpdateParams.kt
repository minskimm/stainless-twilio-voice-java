...
class SourceIpMappingUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{sipDomainSid=$sipDomainSid, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceIpMappingUpdateParams: SourceIpMappingUpdateParams) =
            apply {
    ...
    override fun toString() = "SourceIpMappingUpdateParams{sid=$sid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
