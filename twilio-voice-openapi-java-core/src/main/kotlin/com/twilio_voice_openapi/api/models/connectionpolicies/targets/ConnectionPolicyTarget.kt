...
@NoAutoDetect
class ConnectionPolicyTarget @JsonCreator private constructor(
    ...
    @JsonProperty("priority") @ExcludeMissing private val priority: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("sid") @ExcludeMissing private val sid: JsonField<String> = JsonMissing.of(),
    @JsonProperty("target") @ExcludeMissing private val target: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("weight")
    @ExcludeMissing
    fun _weight(): JsonField<Long> = weight
    ...
    fun validate(): ConnectionPolicyTarget =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyTarget: ConnectionPolicyTarget) =
            apply {
         ...
         * important target.
         */
        fun priority(priority: JsonField<Long>) =
            apply {
         ...
         * more load than those with lower ones with the same priority.
         */
        fun weight(weight: JsonField<Long>) =
            apply {
                this.weight = weight
            }
    ...
    override fun toString() = "ConnectionPolicyTarget{accountSid=$accountSid, connectionPolicySid=$connectionPolicySid, dateCreated=$dateCreated, dateUpdated=$dateUpdated, enabled=$enabled, friendlyName=$friendlyName, priority=$priority, sid=$sid, target=$target, url=$url, weight=$weight, additionalProperties=$additionalProperties}"
}
