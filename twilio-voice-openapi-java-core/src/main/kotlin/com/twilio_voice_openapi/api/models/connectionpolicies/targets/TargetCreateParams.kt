...
class TargetCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{target=$target, enabled=$enabled, friendlyName=$friendlyName, priority=$priority, weight=$weight, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(targetCreateParams: TargetCreateParams) =
            apply {
    ...
    override fun toString() = "TargetCreateParams{connectionPolicySid=$connectionPolicySid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
