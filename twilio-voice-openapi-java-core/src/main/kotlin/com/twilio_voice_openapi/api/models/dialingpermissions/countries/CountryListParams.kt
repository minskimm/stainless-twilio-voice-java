...
class CountryListParams private constructor(
     ...
     */
    fun highRiskSpecialNumbersEnabled(): Optional<Boolean> = Optional.ofNullable(highRiskSpecialNumbersEnabled)
     ...
     */
    fun highRiskTollfraudNumbersEnabled(): Optional<Boolean> = Optional.ofNullable(highRiskTollfraudNumbersEnabled)
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.continent?.let {
          queryParams.put(
            "Continent", listOf(it.toString())
          )
      }
      this.countryCode?.let {
          queryParams.put(
            "CountryCode", listOf(it.toString())
          )
      }
      this.highRiskSpecialNumbersEnabled?.let {
          queryParams.put(
            "HighRiskSpecialNumbersEnabled", listOf(it.toString())
          )
      }
      this.highRiskTollfraudNumbersEnabled?.let {
          queryParams.put(
            "HighRiskTollfraudNumbersEnabled", listOf(it.toString())
          )
      }
      this.isoCode?.let {
          queryParams.put(
            "IsoCode", listOf(it.toString())
          )
      }
      this.lowRiskNumbersEnabled?.let {
          queryParams.put(
            "LowRiskNumbersEnabled", listOf(it.toString())
          )
      }
      this.page?.let {
          queryParams.put(
    ...
    class Builder internal constructor() {
        ...
        /** Filter to retrieve the country permissions by specifying the continent */
        fun continent(continent: String?) =
            apply {
    ...
    override fun toString() = "CountryListParams{continent=$continent, countryCode=$countryCode, highRiskSpecialNumbersEnabled=$highRiskSpecialNumbersEnabled, highRiskTollfraudNumbersEnabled=$highRiskTollfraudNumbersEnabled, isoCode=$isoCode, lowRiskNumbersEnabled=$lowRiskNumbersEnabled, page=$page, pageSize=$pageSize, pageToken=$pageToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
