...
class TargetUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{enabled=$enabled, friendlyName=$friendlyName, priority=$priority, target=$target, weight=$weight, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(targetUpdateParams: TargetUpdateParams) =
            apply {
    ...
    override fun toString() = "TargetUpdateParams{connectionPolicySid=$connectionPolicySid, sid=$sid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
