...
private constructor(
    ...
    fun validate(): DialingPermissionCountryListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [DialingPermissionCountryListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            dialingPermissionCountryListResponse: DialingPermissionCountryListResponse
        ) = apply {
            content = dialingPermissionCountryListResponse.content.map { it.toMutableList() }
            meta = dialingPermissionCountryListResponse.meta
            additionalProperties =
                dialingPermissionCountryListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): DialingPermissionCountryListResponse =
            DialingPermissionCountryListResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DialingPermissionCountryListResponse && content == other.content && meta == other.meta && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DialingPermissionCountryListResponse{content=$content, meta=$meta, additionalProperties=$additionalProperties}"
}
