...
@NoAutoDetect
class IpRecordListResponse @JsonCreator private constructor(
    @JsonProperty("ip_records") @ExcludeMissing private val ipRecords: JsonField<List<IpRecord>> = JsonMissing.of(),
    @JsonProperty("meta") @ExcludeMissing private val meta: JsonField<Meta> = JsonMissing.of(),
    @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

) {

    fun ipRecords(): Optional<List<IpRecord>> = Optional.ofNullable(ipRecords.getNullable("ip_records"))
    ...
    fun validate(): IpRecordListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ipRecordListResponse: IpRecordListResponse) =
            apply {
        ...
        fun ipRecords(ipRecords: JsonField<List<IpRecord>>) =
            apply {
                this.ipRecords = ipRecords.map { it.toMutableList() }
            }

        fun addIpRecord(ipRecord: IpRecord) =
            apply {
                ipRecords = (ipRecords ?: JsonField.of(mutableListOf())).also {
    ...
    override fun toString() = "IpRecordListResponse{ipRecords=$ipRecords, meta=$meta, additionalProperties=$additionalProperties}"
}
