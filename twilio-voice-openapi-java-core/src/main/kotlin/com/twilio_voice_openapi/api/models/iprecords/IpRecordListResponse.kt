...
class IpRecordListResponse
private constructor(
    private val ipRecords: JsonField<List<IpRecord>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        ipRecords: JsonField<List<IpRecord>> = JsonMissing.of(),
        @JsonProperty("meta") @ExcludeMissing meta: JsonField<Meta> = JsonMissing.of(),
    ) : this(ipRecords, meta, mutableMapOf())

    /**
     * @throws TwilioVoiceOpenAPIInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun ipRecords(): Optional<List<IpRecord>> =
        Optional.ofNullable(ipRecords.getNullable("ip_records"))
    ...
    /**
     * Returns the raw JSON value of [ipRecords].
     *
     * Unlike [ipRecords], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("ip_records")
    @ExcludeMissing
    fun _ipRecords(): JsonField<List<IpRecord>> = ipRecords
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [IpRecordListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IpRecordListResponse]. */
    class Builder internal constructor() {

        private var ipRecords: JsonField<MutableList<IpRecord>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(ipRecordListResponse: IpRecordListResponse) = apply {
            ipRecords = ipRecordListResponse.ipRecords.map { it.toMutableList() }
            meta = ipRecordListResponse.meta
            additionalProperties = ipRecordListResponse.additionalProperties.toMutableMap()
        }

        fun ipRecords(ipRecords: List<IpRecord>) = ipRecords(JsonField.of(ipRecords))

        /**
         * Sets [Builder.ipRecords] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ipRecords] with a well-typed `List<IpRecord>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ipRecords(ipRecords: JsonField<List<IpRecord>>) = apply {
            this.ipRecords = ipRecords.map { it.toMutableList() }
        }

        /**
         * Adds a single [IpRecord] to [ipRecords].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addIpRecord(ipRecord: IpRecord) = apply {
            ipRecords =
                (ipRecords ?: JsonField.of(mutableListOf())).also {
                    checkKnown("ipRecords", it).add(ipRecord)
                }
        }
    ...
    fun validate(): IpRecordListResponse = apply {
        if (validated) {
            return@apply
        }

        ipRecords().ifPresent { it.forEach { it.validate() } }
    ...
    internal fun validity(): Int =
        (ipRecords.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IpRecordListResponse && ipRecords == other.ipRecords && meta == other.meta && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(ipRecords, meta, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "IpRecordListResponse{ipRecords=$ipRecords, meta=$meta, additionalProperties=$additionalProperties}"
}
