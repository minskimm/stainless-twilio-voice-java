...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(countryRetrieveParams: CountryRetrieveParams) = apply {
            isoCode = countryRetrieveParams.isoCode
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CountryRetrieveParams && isoCode == other.isoCode && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(isoCode, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CountryRetrieveParams{isoCode=$isoCode, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
