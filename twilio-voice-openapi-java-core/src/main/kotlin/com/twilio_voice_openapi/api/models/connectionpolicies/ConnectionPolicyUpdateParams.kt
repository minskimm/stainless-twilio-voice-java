...
class ConnectionPolicyUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyUpdateParams: ConnectionPolicyUpdateParams) =
            apply {
    ...
    override fun toString() = "ConnectionPolicyUpdateParams{sid=$sid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
