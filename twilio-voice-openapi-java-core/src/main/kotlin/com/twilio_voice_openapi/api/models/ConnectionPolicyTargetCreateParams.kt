...
class ConnectionPolicyTargetCreateParams
private constructor(
    ...
    companion object {
         ...
         * [ConnectionPolicyTargetCreateParams].
         *
         * The following fields are required:
         * ```java
         * .connectionPolicySid()
    ...
    /** A builder for [ConnectionPolicyTargetCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyTargetCreateParams: ConnectionPolicyTargetCreateParams) =
            apply {
                connectionPolicySid = connectionPolicyTargetCreateParams.connectionPolicySid
                body = connectionPolicyTargetCreateParams.body.toBuilder()
                additionalHeaders = connectionPolicyTargetCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    connectionPolicyTargetCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ConnectionPolicyTargetCreateParams =
            ConnectionPolicyTargetCreateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConnectionPolicyTargetCreateParams && connectionPolicySid == other.connectionPolicySid && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ConnectionPolicyTargetCreateParams{connectionPolicySid=$connectionPolicySid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
