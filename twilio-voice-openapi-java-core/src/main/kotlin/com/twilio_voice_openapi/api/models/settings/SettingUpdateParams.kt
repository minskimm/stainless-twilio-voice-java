...
class SettingUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("DialingPermissionsInheritance") @ExcludeMissing private val dialingPermissionsInheritance: JsonField<Boolean> = JsonMissing.of(),
         ...
         * Project; otherwise `false`.
         */
        fun dialingPermissionsInheritance(): Optional<Boolean> = Optional.ofNullable(dialingPermissionsInheritance.getNullable("DialingPermissionsInheritance"))
        ...
        class Builder internal constructor() {
             ...
             * Project; otherwise `false`.
             */
            fun dialingPermissionsInheritance(dialingPermissionsInheritance: Boolean) = dialingPermissionsInheritance(JsonField.of(dialingPermissionsInheritance))
            ...
            fun build(): Body =
                Body(
                  dialingPermissionsInheritance, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{dialingPermissionsInheritance=$dialingPermissionsInheritance, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(settingUpdateParams: SettingUpdateParams) =
            apply {
    ...
    override fun toString() = "SettingUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
