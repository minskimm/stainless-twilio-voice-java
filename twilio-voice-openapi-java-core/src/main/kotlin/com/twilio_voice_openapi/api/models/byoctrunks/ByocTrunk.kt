...
@NoAutoDetect
class ByocTrunk @JsonCreator private constructor(
    @JsonProperty("account_sid") @ExcludeMissing private val accountSid: JsonField<String> = JsonMissing.of(),
    @JsonProperty("cnam_lookup_enabled") @ExcludeMissing private val cnamLookupEnabled: JsonField<Boolean> = JsonMissing.of(),
    @JsonProperty("connection_policy_sid") @ExcludeMissing private val connectionPolicySid: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("from_domain_sid") @ExcludeMissing private val fromDomainSid: JsonField<String> = JsonMissing.of(),
    @JsonProperty("sid") @ExcludeMissing private val sid: JsonField<String> = JsonMissing.of(),
    @JsonProperty("status_callback_method") @ExcludeMissing private val statusCallbackMethod: JsonField<StatusCallbackMethod> = JsonMissing.of(),
    @JsonProperty("status_callback_url") @ExcludeMissing private val statusCallbackUrl: JsonField<String> = JsonMissing.of(),
    @JsonProperty("url") @ExcludeMissing private val url: JsonField<String> = JsonMissing.of(),
    @JsonProperty("voice_fallback_method") @ExcludeMissing private val voiceFallbackMethod: JsonField<VoiceFallbackMethod> = JsonMissing.of(),
    @JsonProperty("voice_fallback_url") @ExcludeMissing private val voiceFallbackUrl: JsonField<String> = JsonMissing.of(),
    @JsonProperty("voice_method") @ExcludeMissing private val voiceMethod: JsonField<VoiceMethod> = JsonMissing.of(),
    @JsonProperty("voice_url") @ExcludeMissing private val voiceUrl: JsonField<String> = JsonMissing.of(),
     ...
     * information.
     */
    fun cnamLookupEnabled(): Optional<Boolean> = Optional.ofNullable(cnamLookupEnabled.getNullable("cnam_lookup_enabled"))

    /**
     * The SID of the Connection Policy that Twilio will use when routing traffic to
     * your communications infrastructure.
     */
    fun connectionPolicySid(): Optional<String> = Optional.ofNullable(connectionPolicySid.getNullable("connection_policy_sid"))
     ...
     */
    fun fromDomainSid(): Optional<String> = Optional.ofNullable(fromDomainSid.getNullable("from_domain_sid"))
    ...
    fun statusCallbackMethod(): Optional<StatusCallbackMethod> = Optional.ofNullable(statusCallbackMethod.getNullable("status_callback_method"))

    /**
     * The URL that we call to pass status parameters (such as call ended) to your
     * application.
     */
    fun statusCallbackUrl(): Optional<String> = Optional.ofNullable(statusCallbackUrl.getNullable("status_callback_url"))

    /** The absolute URL of the resource. */
    fun url(): Optional<String> = Optional.ofNullable(url.getNullable("url"))

    /** The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`. */
    fun voiceFallbackMethod(): Optional<VoiceFallbackMethod> = Optional.ofNullable(voiceFallbackMethod.getNullable("voice_fallback_method"))

    /**
     * The URL that we call when an error occurs while retrieving or executing the
     * TwiML requested from `voice_url`.
     */
    fun voiceFallbackUrl(): Optional<String> = Optional.ofNullable(voiceFallbackUrl.getNullable("voice_fallback_url"))

    /** The HTTP method we use to call `voice_url`. Can be: `GET` or `POST`. */
    fun voiceMethod(): Optional<VoiceMethod> = Optional.ofNullable(voiceMethod.getNullable("voice_method"))
    ...
    @ExcludeMissing
    fun _voiceUrl(): JsonField<String> = voiceUrl
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(byocTrunk: ByocTrunk) =
            apply {
         ...
         * information.
         */
        fun cnamLookupEnabled(cnamLookupEnabled: Boolean?) = cnamLookupEnabled(JsonField.ofNullable(cnamLookupEnabled))
         ...
         * information.
         */
        fun cnamLookupEnabled(cnamLookupEnabled: Boolean) = cnamLookupEnabled(cnamLookupEnabled as Boolean?)
         ...
         * information.
         */
        fun cnamLookupEnabled(cnamLookupEnabled: Optional<Boolean>) = cnamLookupEnabled(cnamLookupEnabled.getOrNull())
         ...
         * information.
         */
        fun cnamLookupEnabled(cnamLookupEnabled: JsonField<Boolean>) =
            apply {
         ...
         * your communications infrastructure.
         */
        fun connectionPolicySid(connectionPolicySid: String?) = connectionPolicySid(JsonField.ofNullable(connectionPolicySid))

        /**
         * The SID of the Connection Policy that Twilio will use when routing traffic to
         * your communications infrastructure.
         */
        fun connectionPolicySid(connectionPolicySid: Optional<String>) = connectionPolicySid(connectionPolicySid.getOrNull())

        /**
         * The SID of the Connection Policy that Twilio will use when routing traffic to
         * your communications infrastructure.
         */
        fun connectionPolicySid(connectionPolicySid: JsonField<String>) =
            apply {
         ...
         * routing. If not configured, the from domain will default to "sip.twilio.com".
         */
        fun fromDomainSid(fromDomainSid: String?) = fromDomainSid(JsonField.ofNullable(fromDomainSid))
         ...
         * routing. If not configured, the from domain will default to "sip.twilio.com".
         */
        fun fromDomainSid(fromDomainSid: Optional<String>) = fromDomainSid(fromDomainSid.getOrNull())
         ...
         * routing. If not configured, the from domain will default to "sip.twilio.com".
         */
        fun fromDomainSid(fromDomainSid: JsonField<String>) =
            apply {
        ...
        /** The HTTP method we use to call `status_callback_url`. Either `GET` or `POST`. */
        fun statusCallbackMethod(statusCallbackMethod: StatusCallbackMethod?) = statusCallbackMethod(JsonField.ofNullable(statusCallbackMethod))

        /** The HTTP method we use to call `status_callback_url`. Either `GET` or `POST`. */
        fun statusCallbackMethod(statusCallbackMethod: Optional<StatusCallbackMethod>) = statusCallbackMethod(statusCallbackMethod.getOrNull())
         ...
         * application.
         */
        fun statusCallbackUrl(statusCallbackUrl: String?) = statusCallbackUrl(JsonField.ofNullable(statusCallbackUrl))

        /**
         * The URL that we call to pass status parameters (such as call ended) to your
         * application.
         */
        fun statusCallbackUrl(statusCallbackUrl: Optional<String>) = statusCallbackUrl(statusCallbackUrl.getOrNull())

        /**
         * The URL that we call to pass status parameters (such as call ended) to your
         * application.
         */
        fun statusCallbackUrl(statusCallbackUrl: JsonField<String>) =
            apply {
        ...
        /** The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`. */
        fun voiceFallbackMethod(voiceFallbackMethod: VoiceFallbackMethod?) = voiceFallbackMethod(JsonField.ofNullable(voiceFallbackMethod))

        /** The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`. */
        fun voiceFallbackMethod(voiceFallbackMethod: Optional<VoiceFallbackMethod>) = voiceFallbackMethod(voiceFallbackMethod.getOrNull())

        /** The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`. */
        fun voiceFallbackMethod(voiceFallbackMethod: JsonField<VoiceFallbackMethod>) =
            apply {
         ...
         * TwiML requested from `voice_url`.
         */
        fun voiceFallbackUrl(voiceFallbackUrl: String?) = voiceFallbackUrl(JsonField.ofNullable(voiceFallbackUrl))

        /**
         * The URL that we call when an error occurs while retrieving or executing the
         * TwiML requested from `voice_url`.
         */
        fun voiceFallbackUrl(voiceFallbackUrl: Optional<String>) = voiceFallbackUrl(voiceFallbackUrl.getOrNull())

        /**
         * The URL that we call when an error occurs while retrieving or executing the
         * TwiML requested from `voice_url`.
         */
        fun voiceFallbackUrl(voiceFallbackUrl: JsonField<String>) =
            apply {
        ...
        /** The HTTP method we use to call `voice_url`. Can be: `GET` or `POST`. */
        fun voiceMethod(voiceMethod: JsonField<VoiceMethod>) =
            apply {
        ...
        /** The URL we call using the `voice_method` when the BYOC Trunk receives a call. */
        fun voiceUrl(voiceUrl: JsonField<String>) =
            apply {
    ...
    /** The HTTP method we use to call `status_callback_url`. Either `GET` or `POST`. */
    class StatusCallbackMethod @JsonCreator private constructor(
         ...
         * [_UNKNOWN] member.
         *
         * An instance of [StatusCallbackMethod] can contain an unknown value in a couple
         * of cases:
         *
         ...
         *
         * @throws TwilioVoiceOpenAPIInvalidDataException if this class instance's value is
        ...
        fun known(): Known =
            when (this) {
                GET -> Known.GET
                POST -> Known.POST
                else -> throw TwilioVoiceOpenAPIInvalidDataException("Unknown StatusCallbackMethod: $value")
            }
         ...
         *
         * @throws TwilioVoiceOpenAPIInvalidDataException if this class instance's value
         * does not have the expected primitive type.
         */
        fun asString(): String = _value().asString().orElseThrow { TwilioVoiceOpenAPIInvalidDataException("Value is not a String") }
    ...
    /** The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`. */
    class VoiceFallbackMethod @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [VoiceFallbackMethod]'s known values, as well as an
         * [_UNKNOWN] member.
         *
         * An instance of [VoiceFallbackMethod] can contain an unknown value in a couple of
         * cases:
         *
         * - It was deserialized from data that doesn't match any known member. For
         *   example, if the SDK is on an older version than the API, then the API may
        ...
        enum class Value {
            ...
            POST,
            /**
             * An enum member indicating that [VoiceFallbackMethod] was instantiated with an
             * unknown value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                GET -> Known.GET
                POST -> Known.POST
                else -> throw TwilioVoiceOpenAPIInvalidDataException("Unknown VoiceFallbackMethod: $value")
            }
    ...
    /** The HTTP method we use to call `voice_url`. Can be: `GET` or `POST`. */
    class VoiceMethod @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [VoiceMethod]'s known values, as well as an [_UNKNOWN]
         * member.
         *
        ...
        enum class Value {
            ...
            POST,
            /**
             * An enum member indicating that [VoiceMethod] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
