...
class ConnectionPolicyTargetUpdateParams
private constructor(
    ...
    companion object {
         ...
         * [ConnectionPolicyTargetUpdateParams].
         *
    ...
    /** A builder for [ConnectionPolicyTargetUpdateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyTargetUpdateParams: ConnectionPolicyTargetUpdateParams) =
            apply {
                connectionPolicySid = connectionPolicyTargetUpdateParams.connectionPolicySid
                sid = connectionPolicyTargetUpdateParams.sid
                body = connectionPolicyTargetUpdateParams.body.toBuilder()
                additionalHeaders = connectionPolicyTargetUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    connectionPolicyTargetUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ConnectionPolicyTargetUpdateParams =
            ConnectionPolicyTargetUpdateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConnectionPolicyTargetUpdateParams && connectionPolicySid == other.connectionPolicySid && sid == other.sid && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ConnectionPolicyTargetUpdateParams{connectionPolicySid=$connectionPolicySid, sid=$sid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
