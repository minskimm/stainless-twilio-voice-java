...
private constructor(
     ...
     */
    fun byocTrunks(): Optional<List<ByocTrunk>> = byocTrunks.getOptional("byoc_trunks")
    ...
    /**
     * Returns the raw JSON value of [byocTrunks].
     *
     * Unlike [byocTrunks], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("byoc_trunks")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        private var byocTrunks: JsonField<MutableList<ByocTrunk>>? = null
        ...
        /**
         * Sets [Builder.byocTrunks] to an arbitrary JSON value.
         *
         * You should usually call [Builder.byocTrunks] with a well-typed `List<ByocTrunk>` value
        ...
        /**
         * Adds a single [ByocTrunk] to [byocTrunks].
         *
        ...
        /**
         * Returns an immutable instance of [ByocTrunkListResponse].
         *
    ...
    internal fun validity(): Int =
        (byocTrunks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(byocTrunks, meta, additionalProperties) }
    /* spotless:on */
