...
class ConnectionPolicyCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                  friendlyName, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{friendlyName=$friendlyName, additionalProperties=$additionalProperties}"
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ConnectionPolicyCreateParams = builder().build()
    ...
    /** A builder for [ConnectionPolicyCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyCreateParams: ConnectionPolicyCreateParams) =
            apply {
                body = connectionPolicyCreateParams.body.toBuilder()
                additionalHeaders = connectionPolicyCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = connectionPolicyCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ConnectionPolicyCreateParams =
            ConnectionPolicyCreateParams(
              body.build(),
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ConnectionPolicyCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "ConnectionPolicyCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
