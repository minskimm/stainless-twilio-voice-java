...
class ConnectionPolicyCreateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ConnectionPolicyCreateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ConnectionPolicyCreateParams].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyCreateParams: ConnectionPolicyCreateParams) = apply {
        ...
        /**
         * Returns an immutable instance of [ConnectionPolicyCreateParams].
         *
    ...
    override fun toString() =
        "ConnectionPolicyCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
