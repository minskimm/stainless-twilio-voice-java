...
class SourceIpMappingCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("IpRecordSid") @ExcludeMissing private val ipRecordSid: JsonField<String> = JsonMissing.of(),
        @JsonProperty("SipDomainSid") @ExcludeMissing private val sipDomainSid: JsonField<String> = JsonMissing.of(),
        ...
        override fun toString() = "Body{ipRecordSid=$ipRecordSid, sipDomainSid=$sipDomainSid, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceIpMappingCreateParams: SourceIpMappingCreateParams) =
            apply {
         ...
         * map from.
         */
        fun ipRecordSid(ipRecordSid: String) =
            apply {
                body.ipRecordSid(ipRecordSid)
            }
        ...
        /** The SID of the SIP Domain that the IP Record should be mapped to. */
        fun sipDomainSid(sipDomainSid: String) =
            apply {
    ...
    override fun toString() = "SourceIpMappingCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
