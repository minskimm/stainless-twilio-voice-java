...
class IpRecordUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ipRecordUpdateParams: IpRecordUpdateParams) =
            apply {
    ...
    override fun toString() = "IpRecordUpdateParams{sid=$sid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
