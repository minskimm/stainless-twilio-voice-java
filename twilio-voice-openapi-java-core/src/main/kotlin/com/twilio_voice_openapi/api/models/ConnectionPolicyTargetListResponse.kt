...
@NoAutoDetect
class ConnectionPolicyTargetListResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ConnectionPolicyTargetListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ConnectionPolicyTargetListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicyTargetListResponse: ConnectionPolicyTargetListResponse) =
            apply {
                meta = connectionPolicyTargetListResponse.meta
                targets = connectionPolicyTargetListResponse.targets.map { it.toMutableList() }
                additionalProperties =
                    connectionPolicyTargetListResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): ConnectionPolicyTargetListResponse =
            ConnectionPolicyTargetListResponse(
                meta,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConnectionPolicyTargetListResponse && meta == other.meta && targets == other.targets && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ConnectionPolicyTargetListResponse{meta=$meta, targets=$targets, additionalProperties=$additionalProperties}"
}
