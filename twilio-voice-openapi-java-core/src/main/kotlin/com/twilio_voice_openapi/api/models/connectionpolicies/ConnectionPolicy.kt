...
@NoAutoDetect
class ConnectionPolicy @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionPolicy: ConnectionPolicy) =
            apply {
    ...
    override fun toString() = "ConnectionPolicy{accountSid=$accountSid, dateCreated=$dateCreated, dateUpdated=$dateUpdated, friendlyName=$friendlyName, links=$links, sid=$sid, url=$url, additionalProperties=$additionalProperties}"
}
