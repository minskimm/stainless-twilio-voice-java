...
class ByocTrunkCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("CnamLookupEnabled") @ExcludeMissing private val cnamLookupEnabled: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("ConnectionPolicySid") @ExcludeMissing private val connectionPolicySid: JsonField<String> = JsonMissing.of(),
        @JsonProperty("FriendlyName") @ExcludeMissing private val friendlyName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("FromDomainSid") @ExcludeMissing private val fromDomainSid: JsonField<String> = JsonMissing.of(),
        @JsonProperty("StatusCallbackMethod") @ExcludeMissing private val statusCallbackMethod: JsonField<StatusCallbackMethod> = JsonMissing.of(),
        @JsonProperty("StatusCallbackUrl") @ExcludeMissing private val statusCallbackUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("VoiceFallbackMethod") @ExcludeMissing private val voiceFallbackMethod: JsonField<VoiceFallbackMethod> = JsonMissing.of(),
        @JsonProperty("VoiceFallbackUrl") @ExcludeMissing private val voiceFallbackUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("VoiceMethod") @ExcludeMissing private val voiceMethod: JsonField<VoiceMethod> = JsonMissing.of(),
        @JsonProperty("VoiceUrl") @ExcludeMissing private val voiceUrl: JsonField<String> = JsonMissing.of(),
         ...
         * information.
         */
        fun cnamLookupEnabled(): Optional<Boolean> = Optional.ofNullable(cnamLookupEnabled.getNullable("CnamLookupEnabled"))

        /**
         * The SID of the Connection Policy that Twilio will use when routing traffic to
         * your communications infrastructure.
         */
        fun connectionPolicySid(): Optional<String> = Optional.ofNullable(connectionPolicySid.getNullable("ConnectionPolicySid"))
         ...
         * routing. If not configured, the from domain will default to "sip.twilio.com".
         */
        fun fromDomainSid(): Optional<String> = Optional.ofNullable(fromDomainSid.getNullable("FromDomainSid"))

        /**
         * The HTTP method we should use to call `status_callback_url`. Can be: `GET` or
         * `POST`.
         */
        fun statusCallbackMethod(): Optional<StatusCallbackMethod> = Optional.ofNullable(statusCallbackMethod.getNullable("StatusCallbackMethod"))

        /**
         * The URL that we should call to pass status parameters (such as call ended) to
         * your application.
         */
        fun statusCallbackUrl(): Optional<String> = Optional.ofNullable(statusCallbackUrl.getNullable("StatusCallbackUrl"))

        /**
         * The HTTP method we should use to call `voice_fallback_url`. Can be: `GET` or
         * `POST`.
         */
        fun voiceFallbackMethod(): Optional<VoiceFallbackMethod> = Optional.ofNullable(voiceFallbackMethod.getNullable("VoiceFallbackMethod"))

        /**
         * The URL that we should call when an error occurs while retrieving or executing
         * the TwiML from `voice_url`.
         */
        fun voiceFallbackUrl(): Optional<String> = Optional.ofNullable(voiceFallbackUrl.getNullable("VoiceFallbackUrl"))

        /** The HTTP method we should use to call `voice_url`. Can be: `GET` or `POST`. */
        fun voiceMethod(): Optional<VoiceMethod> = Optional.ofNullable(voiceMethod.getNullable("VoiceMethod"))
        ...
        class Builder internal constructor() {
             ...
             * information.
             */
            fun cnamLookupEnabled(cnamLookupEnabled: Boolean) = cnamLookupEnabled(JsonField.of(cnamLookupEnabled))
             ...
             * your communications infrastructure.
             */
            fun connectionPolicySid(connectionPolicySid: String) = connectionPolicySid(JsonField.of(connectionPolicySid))
             ...
             * `POST`.
             */
            fun statusCallbackMethod(statusCallbackMethod: StatusCallbackMethod) = statusCallbackMethod(JsonField.of(statusCallbackMethod))
             ...
             * your application.
             */
            fun statusCallbackUrl(statusCallbackUrl: String) = statusCallbackUrl(JsonField.of(statusCallbackUrl))
             ...
             * `POST`.
             */
            fun voiceFallbackMethod(voiceFallbackMethod: VoiceFallbackMethod) = voiceFallbackMethod(JsonField.of(voiceFallbackMethod))
             ...
             * the TwiML from `voice_url`.
             */
            fun voiceFallbackUrl(voiceFallbackUrl: String) = voiceFallbackUrl(JsonField.of(voiceFallbackUrl))
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ByocTrunkCreateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(byocTrunkCreateParams: ByocTrunkCreateParams) =
            apply {
        ...
        /** The HTTP method we should use to call `voice_url`. Can be: `GET` or `POST`. */
        fun voiceMethod(voiceMethod: VoiceMethod) =
            apply {
    ...
    override fun toString() = "ByocTrunkCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
