...
class ByocTrunkListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ByocTrunkListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(byocTrunkListParams: ByocTrunkListParams) =
            apply {
    ...
    override fun toString() = "ByocTrunkListParams{page=$page, pageSize=$pageSize, pageToken=$pageToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
