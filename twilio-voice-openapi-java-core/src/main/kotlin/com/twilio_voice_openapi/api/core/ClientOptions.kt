...
import com.twilio_voice_openapi.api.core.http.HttpClient
import com.twilio_voice_openapi.api.core.http.PhantomReachableClosingHttpClient
import com.twilio_voice_openapi.api.core.http.QueryParams
import com.twilio_voice_openapi.api.core.http.RetryingHttpClient
...
class ClientOptions private constructor(
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://voice.twilio.com"
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() =
            apply {
                System.getenv("TWILIO_VOICE_OPENAPI_USERNAME")?.let {
                    username(it)
                }
                System.getenv("TWILIO_VOICE_OPENAPI_PASSWORD")?.let {
                    password(it)
                }
            }
        ...
        fun build(): ClientOptions {
          ...
          val username = checkRequired(
            "username", username
          )
          val password = checkRequired(
            "password", password
          )
          ...
          username.let { username ->
              password.let { password ->
                  if (!username.isEmpty() && !password.isEmpty()) {
                      headers.put("Authorization", "Basic ${Base64.getEncoder().encodeToString("$username:$password".toByteArray())}")
                  }
              }
          }
