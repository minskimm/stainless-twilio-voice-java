...
internal constructor(private val clientOptions: ClientOptions) : SourceIpMappingServiceAsync {
    ...
    private val withRawResponse: SourceIpMappingServiceAsync.WithRawResponse by lazy {
    ...
    override fun list(
        params: SourceIpMappingListParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val retrieveHandler: Handler<SourceIpMapping> =
            jsonHandler<SourceIpMapping>(clientOptions.jsonMapper).withErrorHandler(errorHandler)
        ...
        override fun retrieve(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("v1", "SourceIpMappings", params._pathParam(0))
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        private val updateHandler: Handler<SourceIpMapping> =
            jsonHandler<SourceIpMapping>(clientOptions.jsonMapper).withErrorHandler(errorHandler)
        ...
        private val listHandler: Handler<SourceIpMappingListResponse> =
            jsonHandler<SourceIpMappingListResponse>(clientOptions.jsonMapper)
