...
class IpRecordServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : IpRecordService {

    private val withRawResponse: IpRecordService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun retrieve(params: IpRecordRetrieveParams, requestOptions: RequestOptions): IpRecord =
    ...
    override fun list(params: IpRecordListParams, requestOptions: RequestOptions): IpRecordListResponse =
        // get /v1/IpRecords
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: IpRecordCreateParams, requestOptions: RequestOptions): HttpResponseFor<IpRecord> {
        ...
        override fun retrieve(params: IpRecordRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<IpRecord> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: IpRecordUpdateParams, requestOptions: RequestOptions): HttpResponseFor<IpRecord> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("v1", "IpRecords", params.getPathParam(0))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun list(params: IpRecordListParams, requestOptions: RequestOptions): HttpResponseFor<IpRecordListResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "IpRecords")
            .build()
        ...
        override fun delete(params: IpRecordDeleteParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
