...
class ArchiveServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ArchiveService {

    private val withRawResponse: ArchiveService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun deleteCall(params: ArchiveDeleteCallParams, requestOptions: RequestOptions): HttpResponse {
