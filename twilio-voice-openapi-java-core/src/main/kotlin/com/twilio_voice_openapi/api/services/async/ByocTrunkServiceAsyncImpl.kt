...
class ByocTrunkServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ByocTrunkServiceAsync {

    private val withRawResponse: ByocTrunkServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ByocTrunkServiceAsync.WithRawResponse = withRawResponse

    override fun create(params: ByocTrunkCreateParams, requestOptions: RequestOptions): CompletableFuture<ByocTrunk> =
        // post /v1/ByocTrunks
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: ByocTrunkRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ByocTrunk> =
        // get /v1/ByocTrunks/{Sid}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: ByocTrunkUpdateParams, requestOptions: RequestOptions): CompletableFuture<ByocTrunk> =
        // post /v1/ByocTrunks/{Sid}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: ByocTrunkListParams, requestOptions: RequestOptions): CompletableFuture<ByocTrunkListResponse> =
        // get /v1/ByocTrunks
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: ByocTrunkDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: ByocTrunkCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ByocTrunk>> {
        ...
        override fun retrieve(params: ByocTrunkRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ByocTrunk>> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: ByocTrunkUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ByocTrunk>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("v1", "ByocTrunks", params.getPathParam(0))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun list(params: ByocTrunkListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ByocTrunkListResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "ByocTrunks")
            .build()
        ...
        override fun delete(params: ByocTrunkDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
