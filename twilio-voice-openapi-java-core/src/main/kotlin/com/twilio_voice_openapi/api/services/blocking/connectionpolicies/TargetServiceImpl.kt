...
class TargetServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TargetService {

    private val withRawResponse: TargetService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): TargetService.WithRawResponse = withRawResponse

    override fun create(params: TargetCreateParams, requestOptions: RequestOptions): ConnectionPolicyTarget =
        // post /v1/ConnectionPolicies/{ConnectionPolicySid}/Targets
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: TargetRetrieveParams, requestOptions: RequestOptions): ConnectionPolicyTarget =
        // get /v1/ConnectionPolicies/{ConnectionPolicySid}/Targets/{Sid}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun update(params: TargetUpdateParams, requestOptions: RequestOptions): ConnectionPolicyTarget =
        // post /v1/ConnectionPolicies/{ConnectionPolicySid}/Targets/{Sid}
        withRawResponse().update(params, requestOptions).parse()

    override fun list(params: TargetListParams, requestOptions: RequestOptions): TargetListResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: TargetCreateParams, requestOptions: RequestOptions): HttpResponseFor<ConnectionPolicyTarget> {
        ...
        override fun retrieve(params: TargetRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ConnectionPolicyTarget> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: TargetUpdateParams, requestOptions: RequestOptions): HttpResponseFor<ConnectionPolicyTarget> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("v1", "ConnectionPolicies", params.getPathParam(0), "Targets", params.getPathParam(1))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun list(params: TargetListParams, requestOptions: RequestOptions): HttpResponseFor<TargetListResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "ConnectionPolicies", params.getPathParam(0), "Targets")
            .build()
        ...
        override fun delete(params: TargetDeleteParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
