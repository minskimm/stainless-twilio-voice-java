...
class CountryServiceImpl internal constructor(
    ...
    override fun list(params: CountryListParams, requestOptions: RequestOptions): CountryListResponse =
        // get /v1/DialingPermissions/Countries
        withRawResponse().list(params, requestOptions).parse()

    override fun fetchHighRiskSpecialPrefixes(params: CountryFetchHighRiskSpecialPrefixesParams, requestOptions: RequestOptions): CountryFetchHighRiskSpecialPrefixesResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: CountryListParams, requestOptions: RequestOptions): HttpResponseFor<CountryListResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun fetchHighRiskSpecialPrefixes(params: CountryFetchHighRiskSpecialPrefixesParams, requestOptions: RequestOptions): HttpResponseFor<CountryFetchHighRiskSpecialPrefixesResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
