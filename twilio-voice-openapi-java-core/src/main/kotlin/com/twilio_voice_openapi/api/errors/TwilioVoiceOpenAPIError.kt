...
@NoAutoDetect
class TwilioVoiceOpenAPIError @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(twilioVoiceOpenAPIError: TwilioVoiceOpenAPIError) =
            apply {
        ...
        fun build(): TwilioVoiceOpenAPIError = TwilioVoiceOpenAPIError(additionalProperties.toImmutable())
    }
