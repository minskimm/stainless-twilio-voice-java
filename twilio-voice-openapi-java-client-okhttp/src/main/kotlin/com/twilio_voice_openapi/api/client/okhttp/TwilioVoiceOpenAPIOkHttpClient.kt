...
import com.twilio_voice_openapi.api.client.TwilioVoiceOpenAPIClientImpl
...
class TwilioVoiceOpenAPIOkHttpClient private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of
         * [TwilioVoiceOpenAPIOkHttpClient].
         */
        @JvmStatic fun builder() = Builder()

        @JvmStatic fun fromEnv(): TwilioVoiceOpenAPIClient = builder().fromEnv().build()
    }

    /** A builder for [TwilioVoiceOpenAPIOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TwilioVoiceOpenAPIClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TwilioVoiceOpenAPIClient =
            TwilioVoiceOpenAPIClientImpl(
                clientOptions
                    .httpClient(
