...
import com.twilio_voice_openapi.api.core.http.HttpRequestBody
import com.twilio_voice_openapi.api.core.http.HttpResponse
import com.twilio_voice_openapi.api.core.http.HttpMethod
import com.twilio_voice_openapi.api.errors.TwilioVoiceOpenAPIIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(
        ...
        return try {
            ...
            throw TwilioVoiceOpenAPIIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        newCall(request, requestOptions).enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(TwilioVoiceOpenAPIIoException("Request failed", e))
                }
            })
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("TWILIO_VOICE_OPENAPI_LOG")?.lowercase()) {
