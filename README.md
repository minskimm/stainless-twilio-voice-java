...
The most straightforward way to create a [`JsonValue`](twilio-voice-openapi-java-core/src/main/kotlin/com/twilio_voice_openapi/api/core/Values.kt) is using its `from(...)` method:
